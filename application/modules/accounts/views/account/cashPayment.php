<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-slideshare"></i><small> <?php echo 'Cash Payment'; ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_add_account">
                            <div class="x_content"> 
                                <?php echo form_open(site_url('accounts/account/create_bank_recieve'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <input type="hidden" name="txtpage" value="cashPayment">
